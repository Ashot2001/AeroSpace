...
await pg("lessons_en").insert([
    ...
    // TPOICS
     ...
     await pg("topics_en").insert([
      ...
      },
      {
        ...
        image: `${URL_IMAGES}/lesson4_4.jpg`,
  ...
  await pg('questions_en').insert([
    ...
    {
      lesson:'Lesson 1. Introduction to Space Exploration',
      question:'1. What was the first artificial satellite launched into space and which country launched it?',
    ...
    {
      lesson:'Lesson 1. Introduction to Space Exploration',
      question:'2. Who was the first person to travel into space and orbit the Earth?',
    ...
    {
      lesson:'Lesson 1. Introduction to Space Exploration',
      question:'3. Which mission was the first human landing on the moon, and who were the astronauts involved?',
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`4. Which mission was the first human landing on the moon, and who were the astronauts
      involved?`,
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`5. How did the space race between the US and the Soviet Union affect technological
      progress on Earth?`,
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`6. What was the purpose of the Apollo program and what were its main achievements?`,
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`7. What was the result of the launch of Sputnik in 1957 and how did it affect international
      relations?`,
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`8. What role did the space shuttle program play in space exploration, and what were some
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`9. What are the current trends in space exploration and how do they contribute to our
    ...
    {
      lesson:'Lesson 1. Quiz (Introduction to Space Exploration)',
      question:`10. What are the future prospects and goals for space exploration, particularly crewed
    ...
    // Lesson 2
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`1. Which planet in our solar system has the most moons and how many are there?`,
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`2. What is the main feature of Saturn's rings and how are they formed?`,
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`3. Which planet has the largest volcano in the solar system and what is its name?`,
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`4. What is the definition of a dwarf planet, and how many are officially recognized by the
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`5. What is the difference between an asteroid and a comet?`,
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`6. Which spacecraft visited the dwarf planet Pluto in 2015, and what were the significant
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`7. What is an exoplanet and how are they discovered by astronomers?`,
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`8. What are the characteristics that make a planet potentially habitable?`,
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`9. What is the closest exoplanet to our solar system, and what do we know about its
    ...
    {
      lesson:'Lesson 2 / Quiz (Our Solar System and Beyond)',
      question:`10. Which mission will successfully land a Mars rover named Persistence in 2021 and what
      is its primary goal?`,
    ...
    // Lesson 3
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:`1. What is Newton's third law of motion and how does it relate to the motion of rockets?`,
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'2. What are the two main types of rocket propulsion systems and how do they differ?',
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'3. What is the fundamental difference between solid rocket engines and liquid rocket engines?',
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'4. What is the Tsiolkovsky rocket formula and what does it represent?',
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:`5. What is the significance and applications of Tsiolkovsky's formula in rocketry?`,
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:`6. What are the major limitations or challenges associated with rocket propulsion systems?`,
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'7. What are the main factors to consider when designing a rocket shape for optimal aerodynamic performance?',
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'8. How can the center of mass and center of pressure be optimized to ensure stable flight during ascent of a rocket?',
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'9. What are the emerging technologies or concepts being explored to improve missile reusability?',
    ...
    {
      lesson:'Lesson 3 / Quiz (Missiles and propulsion systems)',
      question:'10. How might advances in materials science affect the design and performance of future rockets?',
    ...
    // Lesson 4
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:`1. What is the main function of a communication satellite?`,
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:'2. How do weather satellites contribute to meteorological studies?',
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:'3. How does gravity maneuvering work and how is it used in interplanetary missions?',
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:'4. What is an orbit and how many types of orbits are there?',
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:`5. What factors affect the orbital period of a satellite?`,
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:`6. How is a Hohmann transfer orbiter used to transfer a spacecraft between two circular orbits?`,
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:'7. What is the first space velocity and its significance in space exploration?',
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:`8. Which space probe successfully landed on Saturn's moon Titan and what important discoveries did it make?`,
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:'9. What are the main objectives of the Voyager spacecraft missions?',
    ...
    {
      lesson:'Lesson 4 / Quiz (Spaceship and Missions)',
      question:'10. What were the main goals of the Curiosity rover on Mars?',
  ...
  await pg('satellite_questions_en').insert([
    {
      lesson: `1U quiz`,
      background:`${URL_IMAGES}/quiz.gif`,
      question: `1. What does "1U" refer to in the context of satellites?`,
    ...
    {
      lesson: `1U quiz`,
      question: `2. What materials are commonly used in the construction of 1U satellite structures?`,
    ...
    {
      lesson: `1U quiz`,
      question: `3. Which components are typically housed within the structure of a 1U satellite?`,
    ...
    {
      lesson: `1U quiz`,
      question: `4. What is the payload in a 1U Cubesat?`,
    ...
    {
      lesson: `1U quiz`,
      question: `5. How many stages of separation does a rocket go through before reaching orbit?`,
    ...
    {
      lesson: `1U quiz`,
      question: `6. What is the advantage of deploying 1U satellites from the International Space Station
      (ISS)?`,
    ...
    {
      lesson: `1U quiz`,
      question: `7. How do 1U satellites establish communication links with the International Space Station
      (ISS)?`,
    ...
    {
      lesson: `1U quiz`,
      question: `8. In which orbit are the 1U satellites?`,
    ...
    {
      lesson: `1U quiz`,
      question: `9. How long does a 1U satellite mission last?`,
    ...
    {
      lesson: `1U quiz`,
      question: `10. For what purpose are 1U satellites used?`,
